...
import {
  ...
  ErrorText,
  RetryButton,
  DashboardMainFilterButton,
  DashboardMainFilterButtonHover,
  DashboardClearAllFilterButton,
  DashboardClearAllFilterButtonHover,
} from "./styles";
                ...
                <FilterGrid>
                  ...
                  <FilterGroup>
                    <Button
                      ...
                      css={DashboardMainFilterButton}
                      onMouseEnter={(e) => {
                        const target = e.currentTarget as HTMLElement;
                        target.style.transform = "translateY(-1px)";
                        target.style.boxShadow = "0 6px 16px rgba(139, 92, 246, 0.35)";
                      }}
                      onMouseLeave={(e) => {
                        const target = e.currentTarget as HTMLElement;
                ...
                {activeFilters.length > 0 && (
                  <ActiveFiltersSection>
                    ...
                    <ActiveFiltersContainer>
                      ...
                      <button
                        css={DashboardClearAllFilterButton}
                        onClick={(e) => {
                          e.stopPropagation();
                          e.preventDefault();
                          clearAllFilters();
                        ...
                        onMouseEnter={(e) => {
                          const target = e.currentTarget as HTMLElement;
                          target.style.backgroundColor = "hsl(var(--destructive) / 0.1)";
                        }}
                        onMouseLeave={(e) => {
                          const target = e.currentTarget as HTMLElement;
